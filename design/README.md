...
The two positioning documents that used to live here (`CMAT_GITHUB_PIPELINE_POSITIONING.md`, `POSITIONING_BRIEF.md`) are folded into `ROADMAP.md`'s *Public positioning* section and deleted, per `TODO.md`.
