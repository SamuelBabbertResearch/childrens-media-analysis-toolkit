...
| `docs/project/` | Versioned engineering, project-memory, and working-session documentation; begin with `docs/project/README.md` |
| `docs/wiki/` | Long-form wiki documentation. **Gitignored** — managed separately |
